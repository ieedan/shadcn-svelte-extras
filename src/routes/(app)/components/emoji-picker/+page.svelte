...
<Installation specifier="ui/emoji-picker" />
...
<Playground code={examples.skin.code}>
	<examples.skin.Component />
</Playground>
...
<Playground code={examples.recents.code}>
	<examples.recents.Component />
</Playground>
